...
model = joblib.load('optimized_disease_predictor.pkl')
label_encoder = joblib.load('label_encoder.pkl')
selected_features = joblib.load('selected_features.pkl')

# Complete list of all 132 symptoms
ALL_SYMPTOMS = [
...
def get_closest_symptom(input_symptom):
    """Find the closest matching symptom from the dataset"""
...
def predict_disease(symptoms):
    """Predict disease based on input symptoms with confidence"""
